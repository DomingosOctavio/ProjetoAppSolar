...
namespace Monitor_Energia_Solar
{
    class Conexao_Banco_Dados
    {
        ...
        public MySqlConnection CriarConexao()
        {
            ...
            MySqlConnection connection = new MySqlConnection("Server=31.170.166.124;SslMode=none;User Id=u232657111_arduino;Password=Astecas1508;database=u232657111_bd");
            //127.0.0.1:61468

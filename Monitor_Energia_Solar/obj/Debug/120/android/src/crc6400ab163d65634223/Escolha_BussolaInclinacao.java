...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Monitor_Energia_Solar.Escolha_BussolaInclinacao, br.net.Monitor_Energia_Solar", Escolha_BussolaInclinacao.class, __md_methods);
	}
	...
	public Escolha_BussolaInclinacao ()
	{
		...
		if (getClass () == Escolha_BussolaInclinacao.class)
			mono.android.TypeManager.Activate ("Monitor_Energia_Solar.Escolha_BussolaInclinacao, br.net.Monitor_Energia_Solar", "", this, new java.lang.Object[] {  });
	}
	...
	public Escolha_BussolaInclinacao (int p0)
	{
		super (p0);
		if (getClass () == Escolha_BussolaInclinacao.class)
			mono.android.TypeManager.Activate ("Monitor_Energia_Solar.Escolha_BussolaInclinacao, br.net.Monitor_Energia_Solar", "System.Int32, mscorlib", this, new java.lang.Object[] { p0 });
	}
